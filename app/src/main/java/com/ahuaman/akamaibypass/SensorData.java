...
public class SensorData {
    ...
    public static String randomPair() {
        String randomEvent = randomEvent();
        String str = touchEvent();
        int randomNumber = getRandomNumber(0, 10000);
        int randomNumber2 = getRandomNumber(0, 10000);
        long randomLong = getRandomLong(4294967295L, 999999999999999999L);
        long currentTimeMillis = System.currentTimeMillis();
        int randomNumber3 = getRandomNumber(0, 10000);
        long randomLong2 = getRandomLong(4294967295L, 999999999999999999L);
        int randomNumber4 = getRandomNumber(0, 1000000);
